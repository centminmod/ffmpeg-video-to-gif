...
| S4 | [Spikes/S4-BuildDecision](Spikes/S4-BuildDecision) | Which ffmpeg/ffprobe/gifsicle binaries do we vendor (arch slice, static-vs-build)? | `./probe-ffmpeg.sh` | 🟡 probe done (gifsicle vendorable as-is; ffmpeg needs a pinned static arm64 build) — source pick pending |
